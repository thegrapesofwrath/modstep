...
void singleStep(Point distance){
	char out[50] = "";
...
long long calculateTimePulses(Point distance)
{
	long long out;
	if (distance.x != 0 && distance.y == 0 && distance.z == 0)
	{
		return out = llabs(distance.x);
	}
	else if (distance.x != 0 && distance.y != 0 && distance.z == 0)
	{
		return out = llabs(distance.x * distance.y);
	}
	else if (distance.x == 0 && distance.y != 0 && distance.z == 0)
	{
		return out = llabs(distance.y);
	}
	else if (distance.x == 0 && distance.y == 0 && distance.z != 0)
	{
		return out = llabs(distance.z);
	}
	else if (distance.x == 0 && distance.y != 0 && distance.z != 0)
	{
		return out = llabs(distance.y * distance.z);
	}
	else if (distance.x != 0 && distance.y == 0 && distance.z != 0)
	{
		return out = llabs(distance.x * distance.z);
	}
	else if (distance.x != 0 && distance.y != 0 && distance.z != 0)
	{
		return out = llabs(distance.x * distance.y * distance.z);
	}
	else if (distance.x == 0 && distance.y == 0 && distance.z == 0)
	{
		return out = 0;
